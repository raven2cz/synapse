#!/usr/bin/env python3
"""
Standalone E2E test for Claude/Opus provider.

Run this OUTSIDE of Claude Code (from a regular terminal):
  cd ~/git/github/synapse
  uv run python tests/e2e_resolve_claude.py

This script is identical to e2e_resolve_real.py but tests only the
"claude" provider. It cannot run inside Claude Code due to the
bridge process limitation.
"""
...
logger = logging.getLogger("e2e_resolve_claude")
logger.setLevel(logging.INFO)
logging.getLogger("src.avatar.task_service").setLevel(logging.DEBUG)


# =============================================================================
# Test Scenarios (same as e2e_resolve_real.py)
# =============================================================================
...
# =============================================================================
# Test Runner (same as e2e_resolve_real.py)
# =============================================================================
...
def main():
    ...
    for idx, scenario in enumerate(SCENARIOS, 1):
        logger.info(
            "[%d/%d] %s x %s ...",
            idx, len(SCENARIOS), scenario.name, provider,
        )
    ...
    # Print results table
    print("\n" + "=" * 120)
    print("RESOLVE MODEL E2E TEST RESULTS — Claude Provider")
    print("=" * 120)
    print(
